...
// album
Route::get('/delete', [App\Http\Controllers\AlbumController::class, 'delete']);
...
Route::post('/deletes/{id}', [App\Http\Controllers\AlbumController::class, 'deletes'])->name('deletes');
